...
public class LuaParser extends Parser {
	...
	public static final int
		...
		T__6=32, T__5=33, T__4=34, T__3=35, T__2=36, T__1=37, T__0=38, PALAVRA_CHAVE=39, 
		NUMERO=40, NOME=41, CADEIA=42, COMENTARIO=43, WS=44, OP_REL=45, OP_ARIT_BINARIO=46, 
		OP_LOGICOS=47, CONCATENACAO=48, COMPRIMENTO=49, VARAG=50, ABREPAR=51, 
		FECHAPAR=52, ABRECHAV=53, FECHACHAV=54, ABRECOLC=55, FECHACOLC=56;
	public static final String[] tokenNames = {
		"<INVALID>", "'/'", "'elseif'", "'true'", "'return'", "'while'", "';'", 
		"'='", "'^'", "'for'", "'if'", "'<='", "'break'", "'local'", "'do'", "'*'", 
		"','", "'repeat'", "'false'", "'.'", "':'", "'>='", "'~='", "'=='", "'<'", 
		"'>'", "'or'", "'until'", "'%'", "'in'", "'else'", "'function'", "'end'", 
		"'and'", "'nil'", "'+'", "'then'", "'not'", "'-'", "PALAVRA_CHAVE", "NUMERO", 
		"NOME", "CADEIA", "COMENTARIO", "WS", "OP_REL", "OP_ARIT_BINARIO", "OP_LOGICOS", 
		"'..'", "'#'", "'...'", "'('", "')'", "'{'", "'}'", "'['", "']'"
	};
	public static final int
	...
	public final TrechoContext trecho() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__33) | (1L << T__29) | (1L << T__28) | (1L << T__25) | (1L << T__24) | (1L << T__21) | (1L << T__7) | (1L << NOME))) != 0)) {
				{
				{
				setState(52); comando();
				setState(54);
	...
	public final ComandoContext comando() throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				setState(108); ((ComandoContext)_localctx).NOME = match(NOME);
			...
			case 8:
				...
				setState(123); listadenomes();
				setState(124); match(T__9);
				setState(125); listaexp();
			...
			case 9:
				...
				setState(131); ((ComandoContext)_localctx).nomedafuncao = nomedafuncao();
	...
	public final UltimocomandoContext ultimocomando() throws RecognitionException {
		...
		try {
			...
			case T__34:
				enterOuterAlt(_localctx, 1);
				{
				setState(147); match(T__34);
				setState(149);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__35) | (1L << T__20) | (1L << T__7) | (1L << T__4) | (1L << T__1) | (1L << T__0) | (1L << NUMERO) | (1L << NOME) | (1L << CADEIA) | (1L << COMPRIMENTO) | (1L << VARAG) | (1L << ABREPAR) | (1L << ABRECHAV))) != 0)) {
					{
	...
	public final NomedafuncaoContext nomedafuncao() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(154); ((NomedafuncaoContext)_localctx).NOME = match(NOME);
			...
			while (_la==T__19) {
				...
				setState(157); ((NomedafuncaoContext)_localctx).NOME = match(NOME);
			...
			if (_la==T__18) {
				...
				setState(165); ((NomedafuncaoContext)_localctx).NOME = match(NOME);
				}
			}
	...
	public final ListavarContext listavar() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(170); ((ListavarContext)_localctx).var = var();
			...
			while (_la==T__22) {
				...
				setState(173); ((ListavarContext)_localctx).var = var();
				TabelaDeSimbolos.adicionarSimbolo((((ListavarContext)_localctx).var!=null?_input.getText(((ListavarContext)_localctx).var.start,((ListavarContext)_localctx).var.stop):null), Tipo.VARIAVEL);
				}
				}
				setState(180);
	...
	public final VarContext var() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(181); ((VarContext)_localctx).NOME = match(NOME);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(183); expprefixo();
				setState(184); match(ABRECOLC);
				setState(185); exp(0);
				setState(186); match(FECHACOLC);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(188); expprefixo();
	...
	public final ListadenomesContext listadenomes() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(193); ((ListadenomesContext)_localctx).NOME = match(NOME);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(196); ((ListadenomesContext)_localctx).NOME = match(NOME);
					 TabelaDeSimbolos.adicionarSimbolo((((ListadenomesContext)_localctx).NOME!=null?((ListadenomesContext)_localctx).NOME.getText():null), Tipo.VARIAVEL);
					}
					} 
				}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case ABRECOLC:
						{
						setState(238); match(ABRECOLC);
						setState(239); exp(0);
						setState(240); match(FECHACOLC);
						}
						break;
					case T__19:
						{
	...
	public final Expprefixo2Context expprefixo2() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(249); ((Expprefixo2Context)_localctx).var = var();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(252); chamadadefuncao();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(253); match(ABREPAR);
				setState(254); exp(0);
				setState(255); match(FECHAPAR);
				}
				break;
			}
		}
	...
	public final ChamadadefuncaoContext chamadadefuncao() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(259); ((ChamadadefuncaoContext)_localctx).expprefixo = expprefixo();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(263); expprefixo();
				setState(264); match(T__18);
				setState(265); match(NOME);
				setState(266); args();
				}
				break;
			}
	...
	public final ArgsContext args() throws RecognitionException {
		...
		try {
			...
			case ABREPAR:
				enterOuterAlt(_localctx, 1);
				{
				setState(270); match(ABREPAR);
				setState(272);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__35) | (1L << T__20) | (1L << T__7) | (1L << T__4) | (1L << T__1) | (1L << T__0) | (1L << NUMERO) | (1L << NOME) | (1L << CADEIA) | (1L << COMPRIMENTO) | (1L << VARAG) | (1L << ABREPAR) | (1L << ABRECHAV))) != 0)) {
					{
					setState(271); listaexp();
					}
				}

				setState(274); match(FECHAPAR);
				}
				break;
			case ABRECHAV:
				enterOuterAlt(_localctx, 2);
				{
				setState(275); construtortabela();
				}
				break;
			case CADEIA:
				enterOuterAlt(_localctx, 3);
				{
				setState(276); match(CADEIA);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final CorpodafuncaoContext corpodafuncao() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(282); match(ABREPAR);
			setState(284);
			_la = _input.LA(1);
			if (_la==NOME || _la==VARAG) {
				{
				setState(283); listapar();
				}
			}

			setState(286); match(FECHAPAR);
			setState(287); bloco();
	...
	public final ListaparContext listapar() throws RecognitionException {
		...
		try {
			...
			case NOME:
				enterOuterAlt(_localctx, 1);
				{
				setState(290); listadenomes();
				setState(293);
				_la = _input.LA(1);
				if (_la==T__22) {
					{
					setState(291); match(T__22);
					setState(292); match(VARAG);
					}
				}
	...
	public final ConstrutortabelaContext construtortabela() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(298); match(ABRECHAV);
			setState(300);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__35) | (1L << T__20) | (1L << T__7) | (1L << T__4) | (1L << T__1) | (1L << T__0) | (1L << NUMERO) | (1L << NOME) | (1L << CADEIA) | (1L << COMPRIMENTO) | (1L << VARAG) | (1L << ABREPAR) | (1L << ABRECHAV) | (1L << ABRECOLC))) != 0)) {
				{
				setState(299); listadecampos();
				}
			}

			setState(302); match(FECHACHAV);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(305); separadordecampos();
					setState(306); campo();
					}
					} 
				}
			...
			if (_la==T__32 || _la==T__22) {
				{
				setState(313); separadordecampos();
				}
			}
	...
	public final CampoContext campo() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(316); match(ABRECOLC);
				setState(317); exp(0);
				setState(318); match(FECHACOLC);
	...
	public final OpbinContext opbin() throws RecognitionException {
		...
		try {
			...
			setState(330);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__37) | (1L << T__30) | (1L << T__27) | (1L << T__23) | (1L << T__17) | (1L << T__16) | (1L << T__15) | (1L << T__14) | (1L << T__13) | (1L << T__12) | (1L << T__10) | (1L << T__5) | (1L << T__3) | (1L << T__0) | (1L << CONCATENACAO))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public final OpunariaContext opunaria() throws RecognitionException {
		...
		try {
			...
			setState(332);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__0) | (1L << COMPRIMENTO))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public static final String _serializedATN =
		...
		"\6\b\n\f\16\20\22\24\26\30\32\34\36 \"$&(*,.\60